		...
		<div class="aboutWrapper">
			...
			<div class="aboutContainer">
				...
				<p class="p-line" in:fly={{ x: 100, duration: 2000 }}>
					...
					keyboards, like my <a class="links" href="https://github.com/foostan/crkbd">Corne</a>!
				</p>
				...
				<p>
					I built this site with Svelte, you can check out the <a
						class="links"
						href="https://github.com/Vespertine112/Cabin"
						target="_blank">public repo</a
					>!
				</p>
			</div>
		</div>
