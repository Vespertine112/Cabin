    ...
    <div in:fly={cardTransition} out:fly={{y:50, x:50, duration:1000}} class="cardWrapper">
        ...
        <div class="aboutWrapper">
            ...
            <div class="aboutContainer">
                ...
                <p class="p-line" in:fly={{x:-100, duration:2000}} >Grab a copy of my <a class="links" href="https://drive.google.com/file/d/1laEwku355kUeae-_aoF442zvMpOCNZfe/view?usp=sharing" target="_blank">current resume</a> here! </p>
            </div>
